...
import '../Planets.css'
import {StarsRankingsData,BlackHolesRankingsData,BiggestTelescopesRankingsData,
  PlanetsRankingsData,HomeTelescopesRankingsData} from './RankingsData.js'
...
class HomeTelescopesRanking extends Component {
  render(){
    const PlanetsRankinData = HomeTelescopesRankingsData.map(rank => <RankingProps key={rank.title_ranking}
        title_ranking={rank.title_ranking} img_ranking={rank.img_ranking} content_ranking={rank.content_ranking} />)
    return(
      PlanetsRankinData
    )}}
...
export {StarsRanking,BlackHolesRanking,BiggestTelescopesRanking,PlanetsRanking,HomeTelescopesRanking}
